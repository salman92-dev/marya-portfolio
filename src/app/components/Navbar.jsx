...
export default function Navbar() {
  ...
  return (
    <div className="fixed bottom-12 left-1/2 z-50 w-[95%] max-w-5xl -translate-x-1/2">
      <motion.div
        initial={{ y: 100, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.6, ease: [0.4, 0, 0.2, 1] }}
        className="relative rounded-[28px] bg-black/60 backdrop-blur-3xl shadow-2xl border border-white/10"
      >
                    ...
                    {navLinks.map((link, i) => (
                      ...
                      >
                        <Link
                          ...
                          className={`font-2 flex items-center justify-between px-5 py-4 text-lg uppercase tracking-[0.15em] font-medium rounded-2xl transition-all duration-300 group ${
                            activeLink === link.href
